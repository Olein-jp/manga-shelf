...
プラグインの開発版バージョンは `0.1.2-dev` です。SemVer 形式のタグを push すると GitHub Actions が次を実行します。
...
GitHub Release が公開されると、`0.1.2-dev` をインストールした WordPress の管理画面に `0.1.2` の更新通知が表示され、Release に添付された ZIP から更新できます。
